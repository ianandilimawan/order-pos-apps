    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Create New Product</h1>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 dark:border-gray-800 overflow-hidden">
            <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="lg:p-8 px-4 py-4 space-y-6 overflow-x-hidden">
                @csrf
