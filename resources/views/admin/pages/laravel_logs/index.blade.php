                        ...
                        <div class="sticky top-0 z-20 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 px-5 py-4">
                            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <!-- Clear File Button -->
                                    <form method="POST" action="{{ route('admin.laravel-logs.clear', $selectedFile) }}" class="inline m-0" onsubmit="return confirm('Are you sure you want to clear this log file?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="p-1.5 text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-md transition-colors tooltip" title="Clear this log file">
                                ...
                                <!-- Filters -->
                                <form method="GET" action="{{ route('admin.laravel-logs.index') }}" class="flex flex-wrap items-center gap-2 w-full md:w-auto">
                                    ...
                                    <button type="submit" class="px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors text-sm font-medium shadow-sm">
                                        Filter
                                    </button>
