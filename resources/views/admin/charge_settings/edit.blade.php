...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 dark:border-gray-800 overflow-hidden">
            <form action="{{ route('admin.charge_settings.update', $chargeSetting) }}" method="POST" enctype="multipart/form-data" class="lg:p-8 px-4 py-4 space-y-6 overflow-x-hidden">
                @csrf
                @method('PUT')
...
@include('admin.charge_settings.fields')
                ...
                <div class="flex items-center justify-end gap-4 pt-8 border-t border-gray-100 dark:border-gray-800 mt-8">
                    ...
                    <button type="submit" id="submit-btn"
                        ...
                        <span id="submit-text">Update Charge Setting</span>
