    ...
    <div id="loginContainer"
        ...
        <div
            ...
            <div class="w-full lg:w-1/2 p-8 sm:p-12 lg:p-14 flex flex-col justify-center">
                ...
                <!-- Demo Access Roles -->
                <div class="mt-6 mb-8 p-4 bg-gradient-to-r from-blue-50/90 to-indigo-50/90 dark:from-zinc-800/80 dark:to-zinc-800/60 border border-blue-200/60 dark:border-zinc-700/70 rounded-2xl shadow-sm">
                ...
                <!-- Login Form -->
                <form class="space-y-6 pt-6 border-t border-zinc-200/60 dark:border-zinc-800/60" action="{{ route('admin.login.post') }}" method="POST" id="loginForm">
                    @csrf
