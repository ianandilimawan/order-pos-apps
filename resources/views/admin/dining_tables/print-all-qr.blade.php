    ...
    <style>
        @media print {
            ...
            .print-container { 
                ...
                margin: 0 !important;
                page-break-inside: avoid; /* Don't split a sticker across pages */
            }
        }
    </style>
</head>
<body class="bg-gray-100 min-h-screen p-10">
    ...
    <div class="no-print mb-8 flex gap-4 sticky top-4 z-50 bg-white/80 p-4 rounded-xl shadow backdrop-blur-sm w-max">
    ...
    <!-- Grid Container for Screen -->
    <div class="print-grid flex flex-wrap gap-6 justify-center">
        @foreach($diningTables as $diningTable)
            <!-- Sticker Container (60x85mm) -->
            <div class="print-container bg-white w-[60mm] h-[85mm] shadow-2xl rounded-lg overflow-hidden flex flex-col relative border border-gray-200 shrink-0">
