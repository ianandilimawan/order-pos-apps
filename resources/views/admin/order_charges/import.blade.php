...
@section('title', 'Import Order Charges')

@section('content')
    <div class="space-y-6">
        <!-- Page Header -->
        <div>
            <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Import Order Charges</h1>
            <p class="mt-1 lg:text-sm text-xs text-gray-600 dark:text-gray-400">Upload a CSV or Excel file (.csv, .xlsx, .xls) to import ordercharges</p>
        </div>
            ...
            <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.order_charges.import') }}" method="POST" enctype="multipart/form-data" class="lg:p-8 px-4 py-4 space-y-6">
                ...
                <div>
                    ...
                    <ul class="mt-2 list-disc list-inside text-sm text-gray-600 dark:text-gray-400 space-y-1">
                        @php
                            $model = new \App\Models\OrderCharge();
                ...
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('admin.order_charges.downloadSample', ['format' => 'csv']) }}"
                            ...
                            <a href="{{ route('admin.order_charges.downloadSample', ['format' => 'xlsx']) }}"
                    ...
                    <div class="overflow-x-auto">
                        <pre class="text-xs text-gray-600 dark:text-gray-400 font-mono">order_id,charge_setting_id,charge_name,charge_type,charge_rate,charge_amount
123,123,Sample Value,Sample Value,123,123</pre>
                    </div>
                </div>
