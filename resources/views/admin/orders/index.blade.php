...
<!-- Page Header -->
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
            <div>
                <h2 class="lg:text-2xl text-xl font-bold text-gray-900 dark:text-white">Orders</h2>
                <p class="mt-1 lg:text-sm text-xs text-gray-600 dark:text-gray-400">Manage your orders here</p>
            </div>
            <div class="flex flex-wrap gap-3">
                @if(auth()->user() && auth()->user()->hasPermission('create-orders'))
    ...
    <x-confirm-delete-modal title="Delete Order"
