    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Edit Promo</h1>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 dark:border-gray-800 overflow-hidden">
            <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.promos.update', $promo) }}" method="POST" enctype="multipart/form-data" class="lg:p-8 px-4 py-4 space-y-6 overflow-x-hidden">
                @csrf
                @method('PUT')
...
@include('admin.promos.fields')
                ...
                <div class="flex items-center justify-end gap-4 pt-8 border-t border-gray-100 dark:border-gray-800 mt-8">
                    ...
                    <button type="submit" x-bind:disabled="loading"
                        ...
                        <span x-show="!loading">Update Promo</span>
