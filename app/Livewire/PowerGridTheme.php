...
class PowerGridTheme extends Theme
{
    ...
    public function table(): array
    {
        return [
            'layout' => [
                'base' => 'w-full bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6 space-y-4',
                'div' => 'rounded-lg relative border border-gray-200 dark:border-gray-700 overflow-x-auto overflow-y-hidden',
                'table' => 'min-w-full dark:!bg-gray-900 bg-white',
            ...
            'body' => [
                ...
                'tbodyEmpty' => '',
                'tr' => 'border-b border-pg-primary-100 dark:border-pg-primary-700 hover:bg-pg-primary-100 dark:hover:bg-pg-primary-600 even:bg-pg-primary-50/50 odd:bg-white dark:even:bg-pg-primary-800/50 dark:odd:bg-pg-primary-900 transition-colors',
    ...
    public function footer(): array
    {
        return [
            ...
            'footer' => 'mt-4',
            'footer_with_pagination' => 'md:flex md:flex-row w-full items-center justify-between pt-4 overflow-y-auto relative',
        ];
    }
